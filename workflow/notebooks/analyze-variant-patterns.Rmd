...
```{r Strand-Bias, echo = T, fig.align='center', fig.width=6, fig.height=6}
...
```{r Observations, echo = T, fig.align='center', fig.width=6, fig.height=6}
...
```{r Primer Overlaps, echo=T, fig.align='center', fig.width=6, fig.height=6}
