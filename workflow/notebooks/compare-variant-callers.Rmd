...
```{r Raw Variants Overlap, fig.align='center', fig.width=8, fig.height=5}
...
ggsave("raw_caller_upset_plot.png", width = 8, height = 5, dpi = 300)
...
```{r Filtered Variant Overlap, fig.align='center', fig.width=8, fig.height=5}
...
ggsave("filtered_caller_upset_plot.png", width = 8, height = 5, dpi = 300)
