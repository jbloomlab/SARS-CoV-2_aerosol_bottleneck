...
One addional thing I'll do is focus on variants that are found in more than one time point (in either the donor or the contact). These are the most interesting variants for observing patterns over time. 

```{r Summarized Variants, fig.align='center', fig.width=8, fig.height=6, message=FALSE}

# Only plot the SNPs in both rounds of sequencing (same as bottlneck)
