...
```{r Summarized Variants All SNPs long, fig.align='center', fig.width=20, fig.height=5, message=FALSE}
...
plotting.merged.df %>% 
  ...
  ggplot(aes(x = DPI, y = AF, col = Pair, fill = Pair, group = Grouping, shape = Impactor)) +
    ...
    ylab("Allele Frequency") +
    scale_color_manual(values = c("#bd00ba","#0013bd", "#bd0000"),
                       breaks =c("stock", "donor", "recipient")) + 
...
ggsave(paste(figures.dir, "figure-3b.png", sep=""), width = 12, height = 6)
