...
```{r Alternative Plot Filtered Bottlenecks, echo=T, fig.align='center', fig.width=8, fig.height=4}
...
ggsave("./filtered__a_v_d_bottleneck.png", width = 6, height = 4)
...
ggsave("./filtered__impactor_bottleneck.png", width = 8, height = 4)
...
```{r Plot Masked Bottlenecks, echo=T, fig.align='center', fig.width=8, fig.height=4}
...
ggsave("./masked_a_v_d_bottleneck.png", width = 6, height = 4)
...
ggsave("./masked_impactor_bottleneck.png", width = 8, height = 4)
