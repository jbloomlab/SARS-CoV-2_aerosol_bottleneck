...
ggsave(paste("stock_bottleneck.png", sep=""), width = 8, height = 4)
...
False-positive variants seem to be an issue in the experiment so far. Is there a way to screen these out? If I can come up with a data-driven approach to do this, I'll add this somewhere in the previous notebook. 
...
merged.df %>% 
  mutate(FP = if_else(SNP %in% candidate.false.positives, T, F)) 
