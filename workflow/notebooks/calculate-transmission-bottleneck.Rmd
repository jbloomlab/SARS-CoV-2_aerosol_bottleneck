...
ggsave(paste(figures.dir, "impactor_multi_round_only_summarized_bottleneck.png", sep=""), width = 6, height = 4)
...
ggsave(paste(figures.dir, "aerosol_multi_round_only_summarized_bottleneck.png", sep=""), width = 3.5, height = 4)
...
write_csv(mean.multiround.bottleneck, "mean_bottleneck_sizes.csv")
```
