...
Below is a supplemental figure for the paper that shows the depth for each sample included in the paper.

```{r Supplemental Figure 1, fig.align='center', fig.width=12, fig.height=5}
...
trimmed.depth.df %>% 
  # Remove the samples not included in the paper
...
ggsave(paste(figures.dir, "supplemental-figure-1.png", sep=""), width = 12, height = 5)
