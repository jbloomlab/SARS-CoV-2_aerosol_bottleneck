...
```{r TCID50 v. Coverage, echo=TRUE, warning=FALSE, fig.align='center'}
...
```{r RNA Copies v. Coverage, echo=TRUE, warning=FALSE, fig.align='center'}
...
```{r Coverage Fail by DPI, echo=TRUE, warning=FALSE, fig.align='center'}
