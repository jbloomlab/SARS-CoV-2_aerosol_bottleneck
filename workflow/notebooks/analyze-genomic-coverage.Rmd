...
In this notebook, I assess the read depth and coverage in all 117 samples. The goals of this notebook are to: 
...
```{r Untrimmed Depth, echo=T, fig.align='center', fig.width=8, fig.height=6}
...
ggsave("./untrimmed_read_depth.png", width = 8, height = 6)
...
```{r Trimmed Depth, echo=T, fig.align='center', fig.width=8, fig.height=6}
...
ggsave("./trimmed_read_depth.png", width = 8, height = 6)

```

Generally, the depth looks the same. There aren't any huge differences between the depth in primer trimmed and un-trimmed sequences. 
...
```{r TCID50 v. Coverage, echo=TRUE, warning=FALSE, fig.align='center', fig.width = 4, fig.height = 4}
...
ggsave("./trimmed_coverage_v_TCID50.png", width = 4, height = 4)

```

Below, I've also plotted percent genomic coverage by the RNA copy number. 

```{r RNA Copies v. Coverage, echo=TRUE, warning=FALSE, fig.align='center', fig.align='center', fig.width = 4, fig.height = 4}
...
ggsave("./trimmed_coverage_v_RNA_Copies.png", width = 4, height = 4)
...
```{r Coverage Fail by DPI, echo=TRUE, warning=FALSE, fig.align='center', fig.align='center', fig.width = 4, fig.height = 4}
...
ggsave("./coverage_fail_by_DPI.png", width = 4, height = 4)
